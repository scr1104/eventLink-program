...
public class LoginController {
    ...
    public LoginController(UserManager um, AttendeeController ac, OrganizerController oc, VipController vc,
                           InitialPresenter ip, SpeakerController sc, OrganizerManager om, AttendeeManager am,
    ...
    public boolean logIn() throws IOException {
        ...
        if(userManager.authenticate(id, pw)){
            ...
            if (type.equals("organizer")) {
                ...
                return vipController.mainVipControl();
            }
    ...
    /**
     * Regular attendee puts the new input id and pw to sign up.
    ...
    /**
     * User puts the new pre-assigned id and code to verify as a VIP applicant and pw,
     * name to complete signing up.
     * @return back to initial choice option (login/signup).
     */
