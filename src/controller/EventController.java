...
public class EventController {
    ...
    public boolean makeEvent() {
        ...
        try {
            ...
            //Find whether this Event is VIP exclusive or not
            boolean isExclusive = false;
            System.out.println(organizerPresenter.makeExclusiveDisplay());
            String answer = in.nextLine();
            if (answer.equals("yes")) {isExclusive = true;}
            ...
            if (eventManager.canSchedule(startTimeFormat, roomNo)) {
                ...
                eventManager.makeNewEvents(eventName, startTimeFormat, endTimeFormat, roomNo, maxCapacity, userManager.getCurrentUserId(), isExclusive);
                System.out.println(organizerPresenter.successMakeEvent());
                return true;
            }
            System.out.println(organizerPresenter.failMakeEvent());
            return true;
    ...
    public boolean cancelEvent(String eventName) {
        ...
        System.out.println(organizerPresenter.successCancelEvent());
        return true;
    }
    ...
    public boolean rescheduleEvent(String eventName) {
        ...
        try {
            ...
            System.out.println(organizerPresenter.successRescheduleEvent());
            return true;
    ...
    public boolean addSpeaker(String eventName) {
        ...
        if (!speakerManager.speakerExists(speakerName)) {
            System.out.println(organizerPresenter.speakerDNEDisplay());
        ...
        if (userController.speakerTimeAvailable(speakerName, eventName)) {
            ...
            System.out.println(organizerPresenter.speakerSuccessfullyAddedDisplay());
            return true;
        }
        System.out.println(organizerPresenter.speakerBusyDisplay());
        return true;
    }
    ...
    public boolean removeSpeaker(String eventName) {
        ...
        if (!(option > 0 && option <= listOfSpeakers.size())){
            ...
            System.out.println(organizerPresenter.successRemoveSpeakerEvent());
            return true;
        }
