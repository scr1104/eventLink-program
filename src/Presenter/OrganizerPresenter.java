...
public class OrganizerPresenter {
    ...
    /**
     * Display that prompts for the id of the new VIP that will be using an exclusive code.
     */
    public String vipIdDisplay() { return "Enter the id of the new VIP user:"; }

    /**
     * Display that prompts for a new VIP exclusive code.
     */
    public String vipCodeDisplay() { return "Enter the one-time code of the new VIP user:"; }

    /**
     * Display when the VIP id and code combination has already been registered.
     */
    public String vipAlreadyExistsDisplay(){ return "This id & code pair is already in use. Please try again.";}

    /**
     * Display when the VIP id and code combination has successfully been registered.
     */
    ...
    public String notScheduledEventsDisplay() {
        ...
        List<String> newEventNames = readEventFile.getEventNames();
    ...
    public String makeExclusiveDisplay() {
        return "Would you like to make this new event VIP exclusive? Please answer 'yes' or 'no'.";
    }
     ...
     */
    public String speakerDNEDisplay(){ return "This speaker does not exists.";}
    /**
     * Display for when specific Speaker is busy.
     */
    public String speakerBusyDisplay(){
        return "This speaker is not available at the time.";
    }

    /**
     * Display for when specific speaker has been successfully added to event.
     */
    public String speakerSuccessfullyAddedDisplay(){
        return "The speaker was successfully added.";
    }
     ...
     */
    public String successMakeEvent(){
     ...
     */
    public String failMakeEvent(){
        return "Event has failed to be scheduled.";
    }

    /**
     * Display for when event has successfully been cancelled.
     */
    public String successCancelEvent(){
        return "Event has successfully been cancelled.";
    }

    /**
     * Display for when event has successfully been rescheduled.
     */
    public String successRescheduleEvent(){
        return "Event has successfully been rescheduled.";
    }

    /**
     * Display for when specific speaker has been successfully removed from event.
     */
    public String successRemoveSpeakerEvent(){ return "Speaker has successfully been removed from the Event."; }
    ...
    public String chooseRoomDisplay(){
        ...
        for (String lstRoom : lstRooms) {
            returnedString.append(lstRoom).append("\n");
        }
    ...
    /**
     * Display when the user types in a string when the program is asking for an integer.
     */
