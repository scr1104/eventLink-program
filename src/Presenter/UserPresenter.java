...
public class UserPresenter {
    ...
    /**
     * Display how to choose event from the printed list of event options.
     */
    public String chooseEventInstruction(){
        return "Please choose from the following options which event you would like to manage. \n" +
                "(Type 0 to go to the previous menu.)";
    }


    /**
     * Display "No event to show".
     */
    ...
    /**
     * Display options for schedule viewing.
     */
