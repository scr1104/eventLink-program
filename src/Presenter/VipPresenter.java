...
public class VipPresenter {
    ...
    /**
     * Main menu displayed when an vip log in to the system.
    ...
    /**
     * When the VIP clicks "Browse events", the VIP decides whether they want to browse exclusive or regular events.
     */
    public String eventTypeDisplay(){
        String optionOne = "1: Browse VIP - exclusive events";
        String optionTwo = "2: Browse regular events";
        String optionThree = "3: Go back to the main menu";
        return optionOne + "\n" + optionTwo + "\n" + optionThree;
    }


    /**
     * When the vip clicks "browse exclusive events," all responsible events are displayed.
     */
    public String vipEventsDisplay() {
        ...
        List<String> eventNames = eventManager.getVipEventNames();
    ...
    /**
     * When the vip clicks a specific event, if they are enrolled in the event, all options to manage event are displayed.
     * @return a string representing five different options in each line.
     */
    ...
    /**
     * When the vip clicks a specific event, if they are not enrolled in the event, all options to manage event are displayed.
    ...
    /**
     * Display for VipController.messageControl
    ...
    /**
     * Displays list of friends when Vip has no friends.
     */
    ...
    /**
     * Display all chats for VipController.displayAllChats
     * @param allChatList list from messageManager.getEveryOpponent
     * @return a string of receivers that vip is messaging
     */
    public String allChatsDisplay(List<String> allChatList){
    ...
    /**
     * Display for input required in VipController.privateMessage
    ...
    /**
     * Display indicating that the screen is going back to the event management menu.
     */
    public String toEventMenuDisplay() {return "Returning to managing your event";}

    /**
     * Display asking for the contents of the message to be sent to the speaker.
     */
