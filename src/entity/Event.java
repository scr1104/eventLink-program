...
public class Event implements Serializable {
    ...
    public void addSpeaker(String speaker) {
        ...
        if (speakers.size() == 1) {
            this.event_type = "Talk";
            }
        if (speakers.size() > 1) {
            this.event_type = "Panel Discussion";
            }
    }
    ...
    /**
     * Evaluates whether this is a VIP - exclusive event.
     *
     * @return A boolean value representing whether or not this Event is VIP - exclusive.
     */
    public boolean isExclusive() { return this.isExclusive;}
